...
// 与新上传的相对路径（/api/files/xxx）都会经 request.ts 的 resolveFileUrl() 归一成当前 baseUrl 完整地址
export const baseUrl: string = (import.meta.env?.VITE_API_BASE_URL as string) || 'http://localhost:9091'
