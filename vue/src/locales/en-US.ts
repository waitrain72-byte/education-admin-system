/**
 * Core locale pack (English): common words, menus, layout, login/register, home, backend error codes.
 */
export default {
    common: {
        ok: 'OK',
    ...
    pages: {
        ...
        dashboard: {
            title: 'Educational Management · Data Dashboard',
            exit: 'Back to System',
            entry: 'Data Dashboard',
            studentCount: 'Total Students',
            teacherCount: 'Total Teachers',
            courseCount: 'Total Courses',
            choiceCount: 'Enrollments',
            loginToday: 'Logins Today',
            loginWeek: 'Logins This Week',
            pendingApply: 'Pending Leaves',
            ungradedHomework: 'Ungraded Homework',
            scoreChart: 'Score Distribution',
            attendanceChart: 'Attendance Ratio',
            collegeChart: 'Students per College',
            courseTopChart: 'Top 5 Courses',
